<div class="footer">
		...
		<div class="b-copyright">
			<div class="layout">
				<!-- Copyright Text -->
				<span class="copy">Copyright © &nbsp;<?php echo date("Y");?> <a href="#">UMIP | INF | Ing. Irina Fong</a>. All Right Reserved.</span>
				<!-- Social Icons -->
				<ul class="b-social bot">
					<li>Salir:</li>
                    <li><a class="is" href="salir.php"><i class="icon-instagram"></i></a></li>
