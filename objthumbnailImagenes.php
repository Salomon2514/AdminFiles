...
function introduce_imagen($imgRuta, $imgNombre,$imgTipo,$escalaThumb,$numImagen,$id){
    ...
    $this->dir_Thumb ="thumbnail/"; //Directorio dónde se guardará el Thumbnails
	
	
	echo "la imagen es: ".$imgNombre."<br>";
...
function crear_thumbnail(){ 
	...
	global $sql;
		...
		switch ($this->ImgTipo){
			...
			echo "la imagen es: ".$this->ImgNombre."<br>";
			...
			$sql->update("adminarchivos","$string","$update_str");
