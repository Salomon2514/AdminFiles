<div class="footer">
		...
		<div class="b-copyright">
			<div class="layout">
				<!-- Copyright Text -->
				<span class="copy">Copyright ©<?php echo date("Y");?> <a href="#">UMIP | INF | Irina Fong.</a>. All Right Reserved.</span>
				<!-- Social Icons -->
				<ul class="b-social bot">
					<li>Salir:</li>
                    <li><a class="tw" href="salir.php"><i class="icon-twitter"></i></a></li>
