<form id="formTransparencia"   name="formTransparencia" method="post" action="SUBIENDO.php" enctype="multipart/form-data">
...
<div class="itemDatos">
  ...
  <input name="enlaceAnterior" id = "enlaceAnterior"  type="hidden" value= <?php echo $tipoEnlace;?> />	
  <input name="ruta" id = "ruta"  type="hidden" value= <?php echo $ruta;?> />	
  <input name="ArchivoSubido" id = "ArchivoSubido"  type="hidden" value= <?php echo $AchivoUpload;?> />	
  <input name="AnioAnterior" id = "AnioAnterior"  type="hidden" value= <?php echo $AnioArchivo;?> />	
...
<select name="enlace" id="enlace"><?php comboTipoEnlace("transparenciaTipo",$tipoEnlace); ?></select>
</select></fieldset>
