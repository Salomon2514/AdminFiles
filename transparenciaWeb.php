...
switch ($Accion) {
	...
	$Accion = "Modificar";
		...
		$idTransparencia = $_GET['id'];
		//echo "el id del idNoticia es: ".$idNoticia."<br>";
		
		$regTransparencia = $sql->objects("select * from trasnparencia  where id ='$idTransparencia'");
		$consulta = "select * from trasnparencia  where id ='$idTransparencia'";
		//echo $consulta."<br>";
	...
	$tipoEnlace = $regTransparencia->Enlace;
...
<div class="main boxed">
	...
	<div class="b-titlebar">
		<div class="layout">
			...
			<ul class="crumbs">
				<li>You are here:</li>
				<li><a href="transparenciaAdmin.php">Home</a></li>
	...
	<div class="content shortcodes">
		<div class="layout">
			...
			<?php  include("transparencia_form.php"); ?>
