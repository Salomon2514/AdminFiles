...
<head>
    ...
    <script type="application/javascript" src="js/paginacion_ajax_post_consultaLinea.js"></script>
		...
		<div class="layout">
			...
			<div class="b-promo">
				...
				<h3>M&oacute;dulo de Usuarios.</h3>
				 M&oacute;dulo para administrar los usuarios de los m&oacute;dulos de la p&aacute;gina web
                 </div>
			<!-- End Promo Box -->
            
            
			<?php  include("consultaLinea_listado.php"); ?>
